...
const ProductSkeleton = () => {
  return (
    <div className="productItem rounded-xl overflow-hidden border animate-pulse">
      {/* Image Wrapper */}
      <div className="imgWrapper relative w-full overflow-hidden">
        ...
        <span className="absolute top-[15px] left-[15px] bg-gray-300 rounded-md p-2 w-10 h-5"></span>
