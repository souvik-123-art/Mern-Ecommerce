          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-5">
            <div className="col-span-1">
              ...
              <input
                ...
                className="h-[50px] w-full border border-black/30 outline-none focus:border-black/50 rounded-sm p-3 text-sm"
              />
            </div>
            ...
            <div className="col-span-1">
              <h3 className="text-lg font-medium mb-2">Banner Text Align</h3>
              <FormControl fullWidth size="small">
            ...
            {previews?.length !== 0 &&
              previews?.map((image, index) => (
                <div key={image} className="uploadImageWrapper relative">
                  ...
                  <div className="w-full rounded-md overflow-hidden border border-dashed border-black/30 h-[120px] bg-gray-100 hover:bg-gray-200 text-gray-500 relative">
                    <LazyLoadImage
